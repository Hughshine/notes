...
Proof.
  induction m.
  - auto.
  - intro n. simpl.  rewrite -> IHm.  reflexivity.
Qed.
...
(** This definition is different in one crucial respect from previous 
    ...
    but rather a function from [nat] to [Prop] ¡ª that is, a property 
    of numbers. *)

(** We can think of the definition of [even] as defining a Coq 
    property [even] : nat ¡ú Prop, together with primitive theorems 
...
(** [omega] is a tactic for solving goals in Presburger arithmetic, 
